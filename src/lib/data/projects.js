...
const projects = [
    ...
    },
    {
        ...
        description:
            'A web interface with secure APIs, protected by JWT authentication and role-based access control, for efficient book management.',
        techStack: [
            allTechs.mongodb,
            allTechs.react,
            allTechs.redux,
        ...
        githubRepositoryLink:
            'https://github.com/AkshaykumarLilani/library_manager',
    ...
    },
    {
        ...
        description:
            'React-based Inventory Management Web App with Ant Design, Bootstrap, and Redux for frontend. Backend powered by ExpressJS and MongoDB.',
        techStack: [
            allTechs.mongodb,
            allTechs.react,
            allTechs.redux,
        ...
        githubRepositoryLink:
            'https://github.com/AkshaykumarLilani/inventory-management',
    ...
    },
    {
        title: 'LetsCamp',
        description:
            'A comprehensive full-stack campgrounds booking project leveraging MongoDB for the database, Express for the backend framework, and EJS for dynamic templating on the frontend.',
        techStack: [
            allTechs.mongodb,
            allTechs.express,
            allTechs.ejs,
    ...
    },
    {
        ...
        description:
            'BiCycle Shopping website built using HTML, CSS, JavaScript on Frontend and JSON Server as Backend.',
        techStack: [allTechs.javascript, allTechs.html, allTechs.css],
        githubRepositoryLink:
            'https://github.com/AkshaykumarLilani/OnlineBicycleShop',
    ...
    },
    {
        ...
        description:
            'FrontEnd Clone of a popular grocery shopping website: BigBasket. Built using HTML, CSS & Javascript.',
        techStack: [allTechs.javascript, allTechs.html, allTechs.css],
        githubRepositoryLink:
            'https://github.com/AkshaykumarLilani/big-basket-clone',
...

    {
        ...
        description:
            'An open-source PineScript Indicator for TradingView that displays real-time tick data during market hours. Color-coded for quick analysis: red for lower prices, gray for unchanged, and green for higher prices. No historical data storage.',
        techStack: [allTechs.pinescript],
        deployedLink:
            'https://in.tradingview.com/script/SofuBwAz-Time-and-Sales/',
        image: project_TimeAndSalesWindow,
        category: PROJECT_CATEGORIES.PINESCRIPT,
    },
];

export const PROJECT_CATEGORIES_COUNT = JSON.parse(
...
Object.keys(PROJECT_CATEGORIES).forEach((c) => {
    if (c === PROJECT_CATEGORIES.ALL) {
        ...
        PROJECT_CATEGORIES_COUNT[c] = projects.filter(
            (r) => r.category === PROJECT_CATEGORIES[c]
        ).length;
    }
});
