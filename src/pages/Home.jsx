...
const Home = () => {
  const scaleUp = useSpring({from:{transform:"scale(1)"}, to:{transform:"scale(2)"}, reset:true})
  ...
  return (
    <>
      ...
      <div className="home d-flex justify-content-center align-items-center">
        <div className="info-card d-flex flex-column justify-content-around align-items-center">
          <img
            src={profile}
          ...
          <img
            src={curve}
            alt=""
            className="position-absolute top-0 w-100 curve"
          />
          <div>
          ...
          <div className="text-center bio">
            ...
            <p className="mb-0">
              ...
              {" "}<span>Django</span>, <br/><span>Django REST</span> and <span>Python Scripting</span>
            </p>
          </div>
