...
function NavBar() {
    ...
    if (currentWidth <= 1119) {
        return (
            <animated.nav
                className="d-flex justify-content-center py-4 w-100"
                id="nav-menu"
                style={{
                    position: 'fixed',
                    bottom: 0,
            ...
            >
                <div
                    className="d-flex justify-content-between align-items-center py-2 px-2 mx-auto"
                    style={{
        ...
        return (
            <animated.nav
                className="d-flex justify-content-center py-4 mx-auto max-width-desktop"
                id="nav-menu"
                style={{
                    position: 'sticky',
                    top: 0,
            ...
            >
                <div
                    className="d-flex justify-content-between align-items-center py-2 px-2 w-100"
                    style={{
